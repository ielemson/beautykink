...
@section('content')
    <!-- Page Title-->
    @include('frontend._inc.header_single_page', [
        'title_1' => 'Checkout',
        'title_2' => 'Shipping Address',
    ])
                                                            ...
                                                            <div class="delivery-address-form">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="checkout-address1">{{ __('Address') }}
                                                                                1 *</label>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="checkout-country">{{ __('Region / State') }}*</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="custom-control custom-checkbox">
                                                                                ...
                                                                                <label class="custom-control-label"
                                                                                    for="terms_and_conditions">{{ __('I have read and agree to the') }}
                                                                                    <a href="javascript:;"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#termsAndConditionModal">Terms
                                                                                        & Conditions</a> </label>
                                                                            </div>
...
<label class="custom-control-label" for="same_address">{{ __('Same as billing address') }}</label>
                                                                ...
                                                                <div
                                                                    class="d-flex justify-content-between paddin-top-1x mt-4">
                                                                        ...
                                                                        <div class="col-md-12 text-start">
                                                                            <a class="btn-submit"
                                                                                href="{{ route('frontend.cart') }}"> <i
                                                                                    ...
                                                                                    class="hidden-xs-down">{{ __('Back To Cart') }}</span>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
