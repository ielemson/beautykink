...
@section('content')
        ...
        <div class="hero-area3 hero-area4">
            ...
            <div class="heroarea-slider owl-carousel">
                @foreach ($sliders as $slider)
                    <a href="{{ $slider->link }}">
                        <div class="item" style="background: url('{{ asset($slider->photo) }}')"></div>
                    </a>
                @endforeach
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{ isset($home_page4_banner['url1']) ? $home_page4_banner['url1'] : '' }}" class="h3-category">
                            <img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{ asset($home_page4_banner['img1']) }}" alt="">
                        ...
                        <a href="{{ isset($home_page4_banner['url2']) ? $home_page4_banner['url2'] : '' }}" class="h3-category">
                            <img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{ asset($home_page4_banner['img2']) }}" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 middleImage">
                        <a href="{{ isset($home_page4_banner['url3']) ? $home_page4_banner['url3'] : '' }}" class="h3-category">
                            <img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{ asset($home_page4_banner['img3']) }}" alt="">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{ isset($home_page4_banner['url4']) ? $home_page4_banner['url4'] : '' }}" class="h3-category">
                            <img src="{{ asset($home_page4_banner['img4']) }}" alt="">
                        ...
                        <a href="{{ isset($home_page4_banner['url5']) ? $home_page4_banner['url5'] : '' }}" class="h3-category">
                            <img src="{{ asset($home_page4_banner['img5']) }}" alt="">
                                            ...
                                            <div class="product-card ">
                                                ...
                                                <div class="product-card-inner">
                                                    <div class="product-card-body">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="{{ route('frontend.product', $item->slug) }}"> {{ strlen(strip_tags($item->name)) > 35 ? substr(strip_tags($item->name), 0, 35) : strip_tags($item->name) }}</a>
                                                        </h3>
                                                        <div class="rating-stars">
                                                            {!! renderStarRating($item->reviews->avg('rating')) !!}
                                                        </div>
    ...
    @if ($extra_settings->is_t4_popular_category == 1)
        @if ($popular_category_home4 && count($popular_category_home4) > 0)
            @foreach ($popular_category_home4 as $popularcategory)
                <div class="flash-sell-area theme2 mt-50">
                    <div class="container">
                        <div class="row">
                            <div class="col-xxl-12">
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{ asset($service->photo) }}" alt="Shipping">
                                <div class="content">
