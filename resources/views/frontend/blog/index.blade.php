            ...
            <div class="col-xl-9 col-lg-8 order-lg-2">
                        ...
                        <div class="col-md-6">
                            <div class="blog-post">
                                <a class="post-thumb" href="{{ route('frontend.blog.details', $post->slug) }}">
                                    <img src="{{ asset(json_decode($post->photo, true)[array_key_first(json_decode($post->photo, true))]) }}" alt="Blog Post">
                                </a>
                                <div class="post-body">
                                    <ul class="post-meta">
                                        <li>
                                        ...
                                        <li>
                                            <i class="icon-tag"></i><a href="">{{ $post->category->name }}</a>
                                        </li>
                                    </ul>
                                    <h3 class="post-title">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        {{ $posts->links('frontend._inc.pagination') }}
                    </div>
                </div>
            </div>
            <!-- Sidebar          -->
                            ...
                            <div class="entry">
                                <div class="entry-thumb">
                                    <a href="{{ route('frontend.blog.details', $recent->slug) }}">
                                        <img src="{{ asset(json_decode($recent->photo, true)[array_key_first(json_decode($recent->photo, true))]) }}"alt="Post">
                                    </a>
                                </div>
