        ...
        <div class="menu-top-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="t-m-s-a">
                            <a class="track-order-link" href="{{ route('frontend.track.order') }}"><i class="icon-map-pin"></i>{{ __('Track Order') }}</a>
                            <a class="track-order-link compare-mobile d-lg-none" href="{{ route('frontend.compare.index') }}">{{ __('Compare') }}</a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="right-area">
                            ...
                            <div class="t-h-dropdown ">
                                ...
                                <div class="t-h-dropdown-menu">
                                    @foreach (App\Models\Currency::get() as $currency)
                                        <a class="{{ Session::get('currency') == $currency->id ? 'active' : ($currency->is_default == 1 && !Session::has('currency') ? 'active' : '') }}" href="{{ route('frontend.currency.setup', $currency->id) }}"><i class="icon-chevron-right pr-2"></i>{{ $currency->name }}</a>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="login-register ">
                                @if (!Auth::user())
                                    ...
                                    <div class="t-h-dropdown ">
                                        <a class="main-link" href="#">{{ __('Login/Register') }}<i class="icon-chevron-down"></i></a>
                                        <div class="t-h-dropdown-menu">
                                          
                                                <a class="track-order-link mr-0" href="{{route('user.login')}}"><i class="icon-chevron-right pr-2"></i>Login</a>
                                                <a class="track-order-link mr-0" href="{{ route('user.register') }}"><i class="icon-chevron-right pr-2"></i>Register</a>
                                        </div>
                                    </div>
                                @else
                                    <div class="t-h-dropdown">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="toolbar d-flex">
                                ...
                                <div class="toolbar-item hidden-on-mobile">
                                    <a href="{{ route('frontend.compare.index') }}">
                                        <div>
                        ...
                        <div class="nav-inner">
                            <nav class="site-menu">
                                <ul>
                                    ...
                                    @if ($setting->is_campaign == 1)
                                        <li class="{{ request()->routeIs('frontend.campaign') ? 'active' : '' }}">
                                            <a href="{{ route('frontend.campaign') }}">{{ __('Campaign') }}</a>
                                        </li>
                                    @endif
                                    @if ($setting->is_brands == 1)
                                        <li class="{{ request()->routeIs('frontend.brands') ? 'active' : '' }}">
                                            <a href="{{ route('frontend.brands') }}">{{ __('Brands') }}</a>
                                        </li>
                                    @endif
                                    @if ($setting->is_blog == 1)
                                        <li class="{{ request()->routeIs('frontend.blog*') ? 'active' : '' }}">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <section class="widget">
                        ...
                        <form class="row subscriber-form" action="{{ route('frontend.subscriber.submit') }}"
                            method="post">
                            @csrf
                            <div class="col-sm-12">
