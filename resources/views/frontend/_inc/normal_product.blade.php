    ...
    <div class="col-gd">
        <div class="product-card">
            ...
            <div class="product-button-group"><a class="product-button wishlist_store"
                ...
                @if ($item->is_stock())
                    <a class="product-button add_to_single_cart" data-target="{{ $item->id }}"
                        href="javascript:;"><i class="icon-shopping-cart"></i><span>{{ __('To Cart') }}</span>
                    </a>
                @else
                    <a class="product-button" href="{{ route('frontend.product', $item->slug) }}"><i
