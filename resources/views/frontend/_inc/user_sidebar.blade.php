...
<div class="col-lg-4">
    <aside class="user-info-wrapper">
        ...
        <nav class="list-group">
            ...
            <a class="list-group-item {{ request()->is('user/addresses') ? 'active' : '' }}" href="{{ route('user.address') }}"><i class="icon-map"></i>{{ __('Address') }}</a>
            ...
            <a class="list-group-item with-badge" href="{{ route('user.logout') }}"><i class="icon-logout"></i>{{ __('Log out') }}</a>
        </nav>
    </aside>
