                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">
                                <a class="btn btn-sm btn-outline-danger" href="{{ route('frontend.cart.clear') }}">{{ __('Clear Cart') }}</a>
                            </th>
                        </tr>
                    </thead>

                    <tbody id="cart_view_load" data-target="{{ route('frontend.load.cart') }}">
                        @php
                            //  dd($cart);
                        @endphp
                            ...
                            <tr>
                                <td>
                                    <div class="product-item">
                                        <a class="product-thumb" href="{{ route('frontend.product', $item['slug']) }}"><img  src="{{ asset($item['photo']) }}" alt="Product"></a>
                                ...
                                <td class="text-center">
                                    <a class="remove-from-cart" href="{{ route('frontend.cart.destroy', $key) }}" data-toggle="tooltip" title="Remove item">
                                        <i class="icon-x"></i>
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="card-body">
            <div class="shopping-cart-footer">
                ...
                <div class="text-right column text-lg">
                    ...
                    <span class="text-gray-dark">{{ PriceHelper::setCurrencyPrice($cartTotal - (Session::has('coupon') ? round(Session::get('coupon')['discount'], 2) : 0)) }}</span>
                </div>

            </div>
            <div class="shopping-cart-footer">
                <div class="column">
                    <a class="btn btn-secondary btn-sm" href="{{ route('frontend.catalog') }}">
