            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumbs">
                        ...
                        <li><a href="{{ route('frontend.campaign') }}">{{ __('Campaign Products') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                @foreach ($campaign_items as $compaign_item)
                    <div class="col-gd">
                        <div class="product-card">
                            <a class="product-thumb" href="{{ route('frontend.product', $compaign_item->item->slug) }}">
                                ...
                                <img src="{{ asset($compaign_item->item->thumbnail) }}" alt="Product">
                            </a>
