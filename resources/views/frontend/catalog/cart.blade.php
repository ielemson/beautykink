                      ...
                      <div class="col-8 col-md-4">
                        <div class="product-content">
                          ...
                          @if ($item->options->attribute_price > 0)
                            <small><b>@money($item->options->attribute_price,'NGN') x {{$item->qty}}</b></small>
                          @endif
                            ...
                            <div class="col-md-10 col-xs-6">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-xs-2 price">
                                  <h6 class="product-price">@money(($item->price*$item->qty)+$item->options->attribute_price * $item->qty,'NGN')</h6>
                                </div>
                              </div>
                            </div>
