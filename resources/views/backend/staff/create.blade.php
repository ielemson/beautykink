        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('backend.staff.store') }}" method="POST" id="quickForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                  ...
                  <div class="form-group  col-md-6">
                    ...
                    <input type="email" name="email" class="form-control " id="email" placeholder="{{ __('Enter Email') }}" value="{{ old('email') }}">
                  </div>

                  <div class="form-group  col-md-6">
                    <label for="phone">{{ __('Phone Number') }}</label>
                    <input type="text" name='phone' class='form-control ' placeholder="{{ __('Enter Phone Number') }}" value="{{ old('phone') }}">
                  </div>
