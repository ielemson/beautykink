        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('backend.option.store', $item->id) }}" method="POST" id="quickForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                  ...
                  <div class="form-group  col-md-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" name="price" id="price"  min="0" step="0.1" class="form-control" placeholder="{{ __('Enter Price') }}" value="{{ old('price') }}">
                    </div>
                  </div>
