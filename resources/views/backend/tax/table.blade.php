        ...
        <td>
            <div class="input-group-prepend">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{ route("backend.tax.status", [$data->id, 1]) }}">{{ __('Enable') }}</a>
                  <a class="dropdown-item" href="{{ route("backend.tax.status", [$data->id, 0]) }}">{{ __('Disable') }}</a>
                </div>
            </div>
        </td>
        <td>
            <div class="btn-group">
                <a class="btn btn-info btn-sm mr-1"
                    href="{{ route('backend.tax.edit',$data->id) }}">
                ...
                <a class="btn btn-danger btn-sm delete-record" data-toggle="modal"
                    ...
                    data-href="{{ route('backend.tax.destroy', $data->id) }}">
