...
<body id="invoice-print" onload="window.print()" id="page-top">
    ...
    <script type="text/javascript" src="{{ asset('frontend/js/vendor.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontend/js/scripts.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontend/js/plugin/bootstrap-notify/bootstrap-notify.min.js') }}"></script>
