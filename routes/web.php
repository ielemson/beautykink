...
Route::prefix('admin')->group(function(){
  ...
  Route::resource('highlight', HighlighterController::class)->except(['show'])->names([
    ...
    Route::group(['middleware' => 'permissions:Manage Products'], function(){
        ...
        Route::post('/item/restock/limit', [RestockController::class,'itemRestockLimit'])->name('backend.item.restock.limit');
        // ------------------- ITEM RESTOCK -------------------------//
...
Route::group(['middleware' => 'maintainance'], function(){
    Route::group(['middleware' => 'localize'], function(){
        ...
        Route::prefix('user')->group(function(){
            ...
            Route::get('/wishlists/fetch', [WishlistController::class, 'fetchWishList'])->name('user.wishlist.fetch');
        ...
        Route::post('form/cart/add', [CartController::class, 'addCartForm'])->name('frontend.form.addcart');
