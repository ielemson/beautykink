...
class SslCommerzController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $post_data['success_url'] = route('frontend.sslcommerz.notify');
        $post_data['fail_url'] =  route('frontend.checkout.cancel');
        $post_data['cancel_url'] =  route('frontend.checkout.cancel');
