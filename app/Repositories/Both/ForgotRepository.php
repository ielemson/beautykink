...
class ForgotRepository
{
    ...
    */
    public function forgot($data, $request, $auth)
    {
        ...
        $msg = "Please click this link" . '<a href="'. route($auth . '.change.password.token', $token) .'">'. route($auth . '.change.password.token', $token) .'</a>' ."to change your password.";
